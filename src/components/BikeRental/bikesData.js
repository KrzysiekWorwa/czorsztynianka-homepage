import bikeImage1 from "./images/rower-cube-533121-reaction-hybrid-performance-500.webp";
import bikeImage2 from "./images/rower-elektryczny-cube-reaction-hybrid-pro-500-2256345-1080x636.webp";
...
export const bikeList = [
  {
    id: 1,
    title: "Rower elektryczny Cube Reaction hybrid performance",
    description: "Reaction Hybrid Performance korzysta z mocy silnika Bosch Performance Line, akumulatora 500 Wh i łatwej w obsłudze, 9-biegowej przekładni Shimano Cues. Mocne hydrauliczne hamulce tarczowe Shimano zapewniają niezawodną siłę hamowania w każdych warunkach pogodowych. Amortyzowany widelec o skoku 100 mm, wygodne siodełko i nieprzesuwające się chwyty typu lock-on zapewniają wygodę na długich trasach. ",
    price: "Cena: od 150 PLN",
    image: bikeImage1,
  },
  {
    id: 2,
    title: "Rower elektryczny Cube Reaction hybrid pro",
    description: "Reaction Hybrid Pro 800 łączy wszechstronność roweru górskiego z łatwością użytkowania napędzaną silnikiem Bosch. Z łatwością pokonaj każdą trasę, w terenie lub na drodze, dzięki akumulatorowi 800 Wh i płynnie wspomagającemu pedałowanie, cichemu napędowi Bosch CX. W połączeniu z łatwą w obsłudze 12-biegową przekładnią Shimano XT to wszystko, czego potrzebujesz, aby wygodnie pokonać każde wzniesienie.",
    price: "Cena: od 150 PLN",
    image: bikeImage2,
  },
  {
